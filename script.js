...
function playGame(chose) {
    ...
    //print why
    document.querySelector('.js-why').innerHTML = `You <img src="./emoji/${chose}-emoji.png" class="move-icon">  <img src="./emoji/${computerMoveGame}-emoji.png" class="move-icon"> Computer`;
